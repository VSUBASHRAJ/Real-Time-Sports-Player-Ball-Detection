...
It processes video frames in real-time and outputs labeled detections with bounding boxes.
...
3. **Output**  
   ...
   - Labels displayed (Player, Ball, Referee)
...
3. View real-time detection output  
